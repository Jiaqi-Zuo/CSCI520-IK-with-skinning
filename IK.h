...
public:
  ...
  // flag: true = use Tikhonov regularization to perform IK, false = use Pseudoinverse to perform IK
  // Note: eulerAngles is both input and output
  void doIK(const Vec3d * targetHandlePositions, Vec3d * eulerAngles, bool flag);
